...
public data STypeSymbol
  ...
  | \basicType(list[STypeModifier] modifiers, STypeSymbol baseType)
  | \class(loc decl)
  | \union(loc decl)
  | \struct(list[STypeSymbol] fields)
  | \qualifierType(list[STypeModifier] modifiers, STypeSymbol \type)
  | \pointerType(list[STypeModifier] modifiers, STypeSymbol \type)
  | \functionType(STypeSymbol returnType, list[STypeSymbol] parameterTypes)
  | \functionTypeVarArgs(STypeSymbol returnType, list[STypeSymbol] parameterTypes)
  ...
  | \classSpecialization(loc decl, list[STypeSymbol] templateArguments)
  | \enumerationSpecialization(loc specializedBinding, list[STypeSymbol] templateArguments)
  ...
  | \templateTemplate(STypeSymbol child, list[loc] templateParameters)
  ...
  | \functionSetType(loc decl, list[STypeSymbol] templateArguments)
  | \functionSetTypePointer(loc decl, list[STypeSymbol] templateArguments)
