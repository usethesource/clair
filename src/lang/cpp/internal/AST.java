...
public class AST {
  ...
  private static final Type _Declaration_compilationUnit_2 
    = tf.constructor(typestore,_Declaration,"compilationUnit",tf.listType(_Declaration),"imports",tf.listType(_Declaration),"types");
  ...
  public IConstructor Declaration_compilationUnit( IList $imports, IList $types) {
    return vf.constructor(_Declaration_compilationUnit_2 , $imports, $types);
  }
